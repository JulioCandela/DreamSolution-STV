...
( function($) {
	$.mys2jextend = {
			myrichtextextend : function($elem, options) {
				...
				this.requireCss("jquery.wysiwyg.css", "js/editor/jwysiwyg/");
				this.requireCss("jquery.wysiwyg.modal.css", "js/editor/jwysiwyg/");
				this.require("jquery.wysiwyg.js", null, "js/editor/jwysiwyg/");
				if (!this.loadAtOnce) {
					this.require(
						[
